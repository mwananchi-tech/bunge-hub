...
export default function TopicDetail({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-xs font-medium uppercase tracking-widest mb-4"
           style={{ color: "var(--color-muted)" }}>
            ...
            {s.photoUrl
              ? s.slug
                ...
                : <img src={s.photoUrl} alt={s.name}
                       className="w-8 h-8 rounded-full object-cover shrink-0"
                       style={{ border: "1px solid var(--color-border)" }} />
              : <div className="w-8 h-8 rounded-full shrink-0 flex items-center justify-center font-serif text-xs"
