      ...
      >
        ...
        {bill.summary ? (
          <>
            ...
            <ModelBadge model={bill.summaryModel} />
          </>
        ) : (
          <p className="text-sm" style={{ color: "var(--color-muted)" }}>
            A plain-language summary of this bill&apos;s full legislative journey will appear here
            once the enrichment pipeline runs — covering stages reached, key debates, and the
            outcome.
          </p>
        )}
      </div>
              ...
              {journey.map((j: any) => (
                <div key={j.id} className="py-3 flex items-center gap-4">
                  ...
                  <span className="text-sm">
                    {new Date(j.date).toLocaleDateString("en-KE", {
                      day: "numeric",
                      month: "short",
                      year: "numeric",
                    })}
